Shader "Tauri Interactive/Metals/Gold (Red)" {
    Properties 
    {
     ...
     _Cube ("Cubemap", CUBE) = "" {}
     _Albedo ("Albedo", Range(0,1)) = 0.25       
     _EmissionColor ("Emission Color", Color) = (1,0.356,0.0,1)
     _Emission("Emission", Range(0,0.5)) = 0.5
     _Shininess("Shininess", Range(5,0.1)) = 0.7 
    }
