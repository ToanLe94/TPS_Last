...
public class AILicher : MonoBehaviour
{
	...
	void Update () {
        ...
        animator.SetInteger("KindAttacking", kindAttacking);
    ...
    void Patrol ()
    {
        ...
        if (target == null && targetLastKnownPosition == Vector3.zero)
        {
            ...
            {
                walkingToDest = true;
                forward = LerpSpeed(forward, 0.5f, 2);
    ...
    void AttackBehaviour()
    {
        ...
        isLookAround = false;
        isAttacking = true;
        kindAttacking = UnityEngine.Random.Range(1, 4);
